      ...
      <div className="bg-slate-800 rounded-2xl max-w-sm w-full shadow-2xl border border-slate-700 overflow-hidden my-8">
        ...
        <div className="bg-stone-900 text-stone-200 p-3.5 flex items-center justify-between no-print">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={handlePrint}
              className="px-3 py-1 bg-blue-500 hover:bg-blue-900/300 text-black font-bold text-xs rounded-lg flex items-center space-x-1 cursor-pointer"
            >
        ...
        <div className="p-6 bg-white text-black space-y-4 font-mono text-xs shadow-inner" id="printable-receipt">
          ...
          <div className="text-center space-y-1 pb-3 border-b border-dashed border-gray-300">
            ...
            <h2 className="font-bold font-serif text-sm text-black tracking-wider uppercase">
              USAHA SARUNG BATIK
            </h2>
            <p className="text-[10px] text-gray-600 font-sans">
              Jl. Malioboro No. 45 - Pekalongan &amp; Solo
            </p>
            <p className="text-[10px] text-gray-600 font-sans">WA: 0812-3456-7890</p>
          </div>
              ...
              {transaction.items.map((item, idx) => (
                <div key={idx} className="space-y-0.5">
                  ...
                  <div className="flex justify-between text-[10px] text-gray-600">
                    ...
                    <span className="font-bold text-black">{formatRupiah(item.subtotalSelling)}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Footer message */}
          <div className="text-center pt-3 border-t border-dashed border-gray-300 text-[10px] text-gray-600 space-y-0.5">
            <p className="font-bold text-gray-800">Terima Kasih Telah Berbelanja!</p>
